 ...
 * 
 * This file contains all HTML template getter functions for the system.
 * It centralizes the template management to make maintenance easier.
 */
 ...
 * @return {string} HTML content
 */
FOREX.Templates.includeProgressIndicator = function() {
